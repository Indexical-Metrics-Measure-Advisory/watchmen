...
from .collector_lock_service import CollectorLockService
from .distributed_lock import DistributedLock


class UniqueKeyDistributedLock(DistributedLock):

	def __init__(self, lock: CollectorCompetitiveLock, lock_service: CollectorLockService):
		self.lock = lock
...
def get_unique_key_distributed_lock(
		lock: CollectorCompetitiveLock, lock_service: CollectorLockService) -> UniqueKeyDistributedLock:
