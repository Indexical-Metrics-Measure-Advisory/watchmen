...
from watchmen_pipeline_kernel.common import PipelineKernelException, ask_disable_handle_mointor_log
...
def create_monitor_log_pipeline_invoker(
	...
	def handle_monitor_log(monitor_log: PipelineMonitorLog, asynchronized: bool) -> None:
		if ask_disable_handle_mointor_log():
			if monitor_log.status != "ERROR":
				return
