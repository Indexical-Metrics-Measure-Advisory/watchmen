...
CompetitiveLockId = TypeVar('CompetitiveLockId', bound=str)
ScheduledTaskId = TypeVar('ScheduledTaskId', bound=str)
IntegratedRecordId = TypeVar('IntegratedRecordId', bound=str)
ChangeRecordId = TypeVar('ChangeRecordId', bound=str)
ChangeJsonId = TypeVar('ChangeJsonId', bound=str)
...
EventTriggerId = TypeVar('EventTriggerId', bound=str)
ModelTriggerId = TypeVar('ModelTriggerId', bound=str)
TableTriggerId = TypeVar('TableTriggerId', bound=str)
