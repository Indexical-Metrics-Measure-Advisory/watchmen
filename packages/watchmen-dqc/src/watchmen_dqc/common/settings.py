...
class DqcSettings(BaseSettings):
	...
	MONITOR_JOB_DAILY_HOURS: int = 23
	MONITOR_JOB_DAILY_MINUTES: int = 59
	MONITOR_JOB_WEEKLY_DAY_OF_WEEK: str = "mon"  # one of mon - sun
	MONITOR_JOB_WEEKLY_HOURS: int = 23
	MONITOR_JOB_WEEKLY_MINUTES: int = 59
	MONITOR_JOB_MONTHLY_DAY: str = "1"
	MONITOR_JOB_MONTHLY_HOURS: int = 23
	MONITOR_JOB_MONTHLY_MINUTES: int = 59
