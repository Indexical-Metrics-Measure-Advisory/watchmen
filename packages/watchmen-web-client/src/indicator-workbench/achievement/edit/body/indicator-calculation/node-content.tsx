...
export const IndicatorCalculationNodeContent = (props: {
	...
	return <IndicatorCalculationNode id={`calc-${id}`} error={calculatedValues.loadFailed}
		...
		<IndicatorCalculationVariableName>{Lang.INDICATOR_WORKBENCH.ACHIEVEMENT.CURRENT_VALUE}=</IndicatorCalculationVariableName>
		...
		{achievement.compareWithPreviousTimeRange
			? <>
				...
				<IndicatorCalculationVariableName>{Lang.INDICATOR_WORKBENCH.ACHIEVEMENT.PREVIOUS_VALUE}=</IndicatorCalculationVariableName>
				<IndicatorCalculationValue>{calculatedValues.previous?.formatted}</IndicatorCalculationValue>
				<IndicatorCalculationVariableName compact={true}>,</IndicatorCalculationVariableName>
				<IndicatorCalculationVariableName>{Lang.INDICATOR_WORKBENCH.ACHIEVEMENT.INCREMENT_RATIO}=</IndicatorCalculationVariableName>
		...
		{calculatedValues.shouldComputeScore
			? <>
				<IndicatorCalculationVariableName compact={true}>,</IndicatorCalculationVariableName>
				<IndicatorCalculationVariableName>{Lang.INDICATOR_WORKBENCH.ACHIEVEMENT.COMPUTED_SCORE}=</IndicatorCalculationVariableName>
