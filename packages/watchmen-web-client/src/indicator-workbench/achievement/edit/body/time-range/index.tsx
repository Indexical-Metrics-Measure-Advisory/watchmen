...
export const TimeRange = (props: { rootId: string; achievement: Achievement }) => {
	...
	const timeRangeTypeOptions = [
		{value: AchievementTimeRangeType.YEAR, label: Lang.INDICATOR_WORKBENCH.ACHIEVEMENT.TIME_RANGE_YEAR},
		{value: AchievementTimeRangeType.MONTH, label: Lang.INDICATOR_WORKBENCH.ACHIEVEMENT.TIME_RANGE_MONTH}
	];
	...
	return <TimeRangeNodeContainer>
		<TimeRangeNode ref={ref}>
			<span>{Lang.INDICATOR_WORKBENCH.ACHIEVEMENT.TIME_RANGE}</span>
			...
			{achievement.timeRangeType === AchievementTimeRangeType.MONTH
				...
				: null}
			<span>{Lang.INDICATOR_WORKBENCH.ACHIEVEMENT.TIME_RANGE_COMPARE_WITH_PREVIOUS}</span>
