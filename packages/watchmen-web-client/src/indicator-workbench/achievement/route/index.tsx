...
export const AchievementRoute = () => {
	return <>
		...
		<AchievementState/>
		<Switch>
			<Route path={Router.INDICATOR_WORKBENCH_ACHIEVEMENT_QUERY}>
				<AchievementQuery/>
			</Route>
			<Route path={Router.INDICATOR_WORKBENCH_ACHIEVEMENT_EDIT}>
				<AchievementEdit/>
			</Route>
			<Route path="*">
				<Redirect to={Router.INDICATOR_WORKBENCH_ACHIEVEMENT_QUERY}/>
			</Route>
		</Switch>
	</>;
};