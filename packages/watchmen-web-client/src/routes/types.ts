export enum Router {
	...
	INDICATOR_WORKBENCH_BUCKETS = '/indicator-workbench/bucket',
	INDICATOR_WORKBENCH_INDICATORS = '/indicator-workbench/indicator',
	INDICATOR_WORKBENCH_INDICATOR_PREPARE = '/indicator-workbench/indicator/prepare',
	INDICATOR_WORKBENCH_INSPECTION = '/indicator-workbench/inspection',
	INDICATOR_WORKBENCH_ACHIEVEMENT = '/indicator-workbench/navigator',
	INDICATOR_WORKBENCH_ACHIEVEMENT_QUERY = '/indicator-workbench/navigator/query',
	INDICATOR_WORKBENCH_ACHIEVEMENT_EDIT = '/indicator-workbench/navigator/edit/:achievementId',
	INDICATOR_WORKBENCH_OBJECTIVE_ANALYSIS = '/indicator-workbench/catalog',
