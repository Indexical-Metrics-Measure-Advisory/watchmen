export enum Router {
	...
	INDICATOR_INDICATOR_EDIT = '/indicator/indicator/edit',
	// INDICATOR_INSPECTION = '/indicator/inspection',
	// INDICATOR_ACHIEVEMENT = '/indicator/achievement',
	INDICATOR_ACHIEVEMENT_QUERY = '/indicator/achievement/query',
	INDICATOR_ACHIEVEMENT_EDIT = '/indicator/achievement/edit/:achievementId',
	INDICATOR_OBJECTIVE_ANALYSIS = '/indicator/objective-analysis',
	INDICATOR_OBJECTIVE_ANALYSIS_EDIT = '/indicator/objective-analysis/edit/:analysisId',
