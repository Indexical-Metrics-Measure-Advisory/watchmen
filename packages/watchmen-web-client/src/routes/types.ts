export enum Router {
	...
	// IDW_INSPECTION = '/idw/inspection',
	IDW_ACHIEVEMENT = '/idw/achievement',
	IDW_ACHIEVEMENT_ALL = '/idw/achievement/*',
	IDW_ACHIEVEMENT_EDIT = '/idw/achievement/edit/:achievementId',
	IDW_OBJECTIVE_ANALYSIS = '/idw/objective-analysis',
	IDW_OBJECTIVE_ANALYSIS_ALL = '/idw/objective-analysis/*',
	IDW_OBJECTIVE_ANALYSIS_EDIT = '/idw/objective-analysis/edit/:analysisId',
