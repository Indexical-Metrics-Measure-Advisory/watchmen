...
export const En = {
	...
	INDICATOR: {
		...
		OBJECTIVE: {
			...
			REFER_INDICATOR_PLACEHOLDER: 'Indicator?',
			...
			REFER_INDICATOR_ON_TOPIC_FILTER_PLACEHOLDER: 'Factor?',
			REFER_INDICATOR_ON_SUBJECT_FILTER_PLACEHOLDER: 'Column?',
			...
			REFER_FACTOR_PLACEHOLDER: 'Indicator?',
