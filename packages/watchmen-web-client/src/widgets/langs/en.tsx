...
export const En = {
	...
	INDICATOR: {
		...
		OBJECTIVE: {
			...
			VARIABLE_BUCKET_SEGMENT_PLACEHOLDER: 'Segment...',
			...
			FACTOR_FILTER_TOPIC_PLACEHOLDER: 'Factor?',
			FACTOR_FILTER_SUBJECT_PLACEHOLDER: 'Column?',
			INCORRECT_FACTOR_FILTER_FACTOR_OR_COLUMN: 'Unknown selection',
			NO_AVAILABLE_FACTOR_FILTER_FACTOR_OR_COLUMN: 'No available candidate.',
