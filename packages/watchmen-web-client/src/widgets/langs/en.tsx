...
export const En = {
	...
	PLAIN: {
		...
		INDICATOR_CRITERIA_VARIABLES: 'Functions:',
		INDICATOR_CRITERIA_TR_Y2D: '{&y2d}: year to end',
		INDICATOR_CRITERIA_TR_M2D: '{&m2d}: month to end',
		INDICATOR_CRITERIA_TR_YEAR: '{&year}: this year',
		INDICATOR_CRITERIA_TR_MONTH: '{&month}: this month',
		INDICATOR_CRITERIA_TR_LNY: '{&lny}: last n years, from 1st day of year',
		INDICATOR_CRITERIA_TR_LNYM: '{&lnym}: last n years, from 1st day of month',
		INDICATOR_CRITERIA_TR_LNYD: '{&lnyd}: last n years',
		INDICATOR_CRITERIA_TR_LNM: '{&lnm}: last n months, from 1st day of month',
		INDICATOR_CRITERIA_TR_LNMD: '{&lnmd}: last n months',
	...
	INDICATOR: {
		...
		INSPECTION: {
			...
			VALUE_TRANSFORM_LABEL: 'Aggregation:',
			...
			AGGREGATE_ARITHMETIC_IS_REQUIRED: 'Please pick at least one aggregation.',
		...
		OBJECTIVE_ANALYSIS: {
			...
			CREATE_OBJECTIVE_ANALYSIS: 'Define Analysis',
			NEW_OBJECTIVE_ANALYSIS_PREFIX: 'A New',
			EXISTING_OBJECTIVE_ANALYSIS_PREFIX: 'An Existing',
			CREATE_AT: 'Created At',
			LAST_MODIFIED_AT: 'Last Modified At',
