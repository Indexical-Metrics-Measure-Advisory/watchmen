...
export const En = {
	...
	PLAIN: {
		...
		LOADING: 'Loading...',
		FIND_INDICATOR_PLACEHOLDER: 'Find by indicator base name, description',
		FIND_TOPIC_OR_FACTOR_OR_SUBJECT_PLACEHOLDER: 'Find by topic name, factor name, subject name.',
		INDICATOR_NAME_PLACEHOLDER: 'A human reading name for indicator base.',
		...
		INDICATOR_CRITERIA_TIME_RANGE_YEAR: 'Use "year" to refer predefined time range.',
		INDICATOR_CRITERIA_TIME_RANGE_MONTH: 'Use "month" to refer predefined time range.',
	...
	INDICATOR: {
		...
		INDICATOR: {
			LIST_TITLE: 'Indicator Bases',
			LIST_CREATE_INDICATOR: 'Define Indicator Base',
			LIST_LABEL: 'Indicator Base',
			NEW_INDICATOR_PREFIX: 'A New',
			EXISTING_INDICATOR_PREFIX: 'An Existing',
			CREATE_AT: 'Created At',
			LAST_MODIFIED_AT: 'Last Modified At',
			TITLE: 'Define Indicator Base',
			STEP: 'Step',
			...
			ON_CREATE_INDICATOR: 'Defining An Indicator Base',
			ON_VIEW_INDICATOR: 'View Indicator Base',
			RESTART: 'Restart',
			...
			FAILED_TO_LOAD_INDICATOR: 'Failed to load indicator base, contact your administrator for more information.',
			MEASURE_METHODS_TITLE: 'Available measures of current indicator base were detected automatically.',
			FACTOR: 'Factor',
			FACTOR_NAME: 'Name',
			FACTOR_LABEL: 'Label',
			FACTOR_TYPE: 'Type',
			...
			NOT_NOW: 'Not Now',
			SAVE_INDICATOR: 'Save Indicator Base',
			SAVE_NAME: 'Save Name',
			REQUIRE_INDICATOR_NAME: 'A human reading name for indicator base is required.',
			RELEVANT_TITLE: 'Relevant indicator bases of current indicator can be detected automatically.',
			INDICATOR_NAME: 'Indicator Base',
			INDICATOR_RELEVANT_TYPE: 'Relevant Type',
			IRRELEVANT: 'Irrelevant',
			NO_RELEVANT_DETECTED: 'No relevant indicator base detected yet.',
			DETECT_RELEVANT: 'Detect Potential Relevant Indicator bases',
			IGNORE_DETECT_RELEVANT: 'Ignore Detect Now',
			USER_GROUP: 'User group.',
			ASSIGN_USER_GROUP: 'Assign to User Group',
			DISCARD_ASSIGN_USER_GROUP: 'Discard Assign',
			FILTERS_ON_TOPIC: 'Data restriction.',
			FILTERS_ON_SUBJECT: 'Data restriction already be defined on subject and space, will be inherited by indicator base.',
			CATEGORIES_TITLE: 'Categories.',
			DESCRIPTION_TITLE: 'Description.',
			LAST_STEP_TITLE: 'Indicator base is ready.',
		...
		ACHIEVEMENT: {
			...
			LABEL: 'Achievement',
			OR: 'or',
			PICK_ACHIEVEMENT_LABEL: 'Pick an Achievement:',
			PICKED_ACHIEVEMENT_LABEL: 'Picked Achievement:',
			PICK_ACHIEVEMENT: 'Pick Selection',
			SET_NAME_LABEL: 'Set Name',
			NAME_IS_REQUIRED: 'Please assign a human reading name to achievement.',
			NONAME_ON_ACHIEVEMENT: 'Noname yet',
			RENAME: 'Rename',
			NEW_NAME: 'Name It Now',
