...
export const Jp: LanguageDeclareType = {
	...
	INDICATOR: {
		...
		OBJECTIVE: {
			...
			FACTOR_FILTER_TOPIC_PLACEHOLDER: 'ファクター？',
			FACTOR_FILTER_SUBJECT_PLACEHOLDER: 'カラム？',
			INCORRECT_FACTOR_FILTER_FACTOR_OR_COLUMN: 'ターゲットにできない選択',
			NO_AVAILABLE_FACTOR_FILTER_FACTOR_OR_COLUMN: 'オプションはありません。',
			ADD_INDICATOR: '指標を追加',
