...
export const Jp = {
	...
	PLAIN: {
		...
		INDICATOR_CRITERIA_VARIABLES: '関数:',
		INDICATOR_CRITERIA_TR_Y2D: '{&y2d}: その年',
		INDICATOR_CRITERIA_TR_M2D: '{&m2d}: その月',
		INDICATOR_CRITERIA_TR_YEAR: '{&year}: その年',
		INDICATOR_CRITERIA_TR_MONTH: '{&month}: その月',
		INDICATOR_CRITERIA_TR_LNY: '{&lny}: 直近のn年、nは数字で、1月1日から',
		INDICATOR_CRITERIA_TR_LNYM: '{&lnym}: 直近のn年、nは数字で、同月1日から',
		INDICATOR_CRITERIA_TR_LNYD: '{&lnyd}: 直近のn年、nは数字で',
		INDICATOR_CRITERIA_TR_LNM: '{&lnm}: 直近のn月、nは数値で、1日から',
		INDICATOR_CRITERIA_TR_LNMD: '{&lnmd}: 直近のn月、nは数値で',
	...
	INDICATOR: {
		...
		INDICATOR: {
			...
			ASSIGN_USER_GROUP: 'ユーザー グループの承認',
			DISCARD_ASSIGN_USER_GROUP: '捨てる',
		...
		INSPECTION: {
			...
			AGGREGATE_ARITHMETIC_IS_REQUIRED: '指標値の集計方法を少なくとも 1 つ選択してください。',
