...
export const Zh: LanguageDeclareType = {
	...
	INDICATOR: {
		...
		OBJECTIVE: {
			...
			FACTOR_FORMULA: '计算方法',
			INCORRECT_INDICATOR: '无法定位的指标',
			NO_AVAILABLE_INDICATOR: '没有可供选择的指标.',
			INDICATOR_PLACEHOLDER: '指标?',
			FACTOR_INDICATOR_NOT_READY: '现在无法设置, 请先选择指标.',
			FACTOR_NO_FILTER: '所有数据',
			FACTOR_FILTER_TOPIC_PLACEHOLDER: '数据因子?',
			FACTOR_FILTER_SUBJECT_PLACEHOLDER: '数据集列?',
			INCORRECT_FACTOR_FILTER_FACTOR_OR_COLUMN: '无法定位的选择项',
			NO_AVAILABLE_FACTOR_FILTER_FACTOR_OR_COLUMN: '没有可选项.',
			ADD_INDICATOR: '添加指标',
