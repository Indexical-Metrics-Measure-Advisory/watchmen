...
export const Zh = {
	...
	PLAIN: {
		...
		INDICATOR_CRITERIA_TIME_RANGE_YEAR_MONTH: '填写"year"或"month"来引用统一定义的时间窗口.',
		INDICATOR_CRITERIA_TIME_RANGE_YEAR: '填写"year"来引用统一定义的年份.',
		INDICATOR_CRITERIA_TIME_RANGE_MONTH: '填写"month"来引用统一定义的月份.',
