...
export const Zh: LanguageDeclareType = {
	...
	PLAIN: {
		...
		INDICATOR_CRITERIA_VARIABLES: '函数:',
		INDICATOR_CRITERIA_TR_Y2D: '{&y2d}: 当年',
		INDICATOR_CRITERIA_TR_M2D: '{&m2d}: 当月',
		INDICATOR_CRITERIA_TR_YEAR: '{&year}: 当年',
		INDICATOR_CRITERIA_TR_MONTH: '{&month}: 当月',
		INDICATOR_CRITERIA_TR_LNY: '{&lny}: 最近n年, n为数字, 从1月1日开始',
		INDICATOR_CRITERIA_TR_LNYM: '{&lnym}: 最近n年, n为数字, 从同月份1日开始',
		INDICATOR_CRITERIA_TR_LNYD: '{&lnyd}: 最近n年, n为数字',
		INDICATOR_CRITERIA_TR_LNM: '{&lnm}: 最近n月, n为数字, 从1日开始',
		INDICATOR_CRITERIA_TR_LNMD: '{&lnmd}: 最近n月, n为数字',
	...
	INDICATOR: {
		...
		INDICATOR: {
			...
			USER_GROUP: '用户组.',
			ASSIGN_USER_GROUP: '用户组授权',
			DISCARD_ASSIGN_USER_GROUP: '放弃',
		...
		INSPECTION: {
			...
			PRINT: '打印',
			PICK_ANOTHER: '查看其他洞察',
			AGGREGATE_ARITHMETIC_IS_REQUIRED: '请至少选择一种指标聚合方式.',
		...
		OBJECTIVE_ANALYSIS: {
			TITLE: '目标达成分析',
			LABEL: '目标达成分析',
			CREATE_OBJECTIVE_ANALYSIS: '创建新分析',
			NEW_OBJECTIVE_ANALYSIS_PREFIX: '新',
			EXISTING_OBJECTIVE_ANALYSIS_PREFIX: '已存在的',
			CREATE_AT: '创建于',
			LAST_MODIFIED_AT: '最后更新于',
			NAVIGATOR_TITLE: '导航',
