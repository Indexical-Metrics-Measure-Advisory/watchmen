...
export const Zh: LanguageDeclareType = {
	...
	INDICATOR: {
		...
		OBJECTIVE: {
			...
			REFER_INDICATOR_PLACEHOLDER: '指标?',
			...
			REFER_INDICATOR_ON_TOPIC_FILTER_PLACEHOLDER: '数据因子?',
			REFER_INDICATOR_ON_SUBJECT_FILTER_PLACEHOLDER: '数据集列?',
