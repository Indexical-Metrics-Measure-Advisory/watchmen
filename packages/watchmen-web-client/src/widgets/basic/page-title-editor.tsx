...
const Container = styled.div.attrs({'data-widget': 'page-title-editor'})`
    ...
    > div[data-widget=page-title-editor-label]:first-child:last-child {
        visibility: visible;
    }
`;
...
export const PageTitleEditor = (props: {
	...
	return <Container>
		<Label>{label}</Label>
		<Editor value={title} placeholder={defaultTitle} onChange={onTextChange} onBlur={onBlur}/>
	</Container>;
};

export const PageTitleViewer = (props: { title: string }) => {
	const {title} = props;
