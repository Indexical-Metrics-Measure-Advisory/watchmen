...
const AvailableOperators = [
	...
	ObjectiveFormulaOperator.MULTIPLY, ObjectiveFormulaOperator.DIVIDE, ObjectiveFormulaOperator.MODULUS,
	ObjectiveFormulaOperator.YEAR_OF, ObjectiveFormulaOperator.HALF_YEAR_OF,
	ObjectiveFormulaOperator.QUARTER_OF, ObjectiveFormulaOperator.MONTH_OF,
	ObjectiveFormulaOperator.WEEK_OF_YEAR, ObjectiveFormulaOperator.WEEK_OF_MONTH,
	ObjectiveFormulaOperator.DAY_OF_MONTH, ObjectiveFormulaOperator.DAY_OF_WEEK,
	ObjectiveFormulaOperator.CASE_THEN
];

export const FormulaOperatorEditor = (props: {
	objective: Objective; parameter: ComputedObjectiveParameter;
}) => {
