...
export const NumericSegmentHolderEditor = (props: { holder: NumericSegmentsHolder }) => {
	...
	const includingOptions: Array<DropdownOption> = [
		{value: RangeBucketValueIncluding.INCLUDE_MIN, label: Lang.INDICATOR.BUCKET.RANGE_INCLUDE_MIN},
		{value: RangeBucketValueIncluding.INCLUDE_MAX, label: Lang.INDICATOR.BUCKET.RANGE_INCLUDE_MAX}
	];

	return <>
		<TuplePropertyLabel>{Lang.INDICATOR.BUCKET.RANGE_INCLUDING_LABEL}</TuplePropertyLabel>
