...
const BucketTypes: Record<BucketType, string> = {
	[BucketType.VALUE]: Lang.INDICATOR.BUCKET.BUCKET_TYPE_VALUE,
	[BucketType.VALUE_MEASURE]: Lang.INDICATOR.BUCKET.BUCKET_TYPE_VALUE_MEASURE,
	[BucketType.CATEGORY_MEASURE]: Lang.INDICATOR.BUCKET.BUCKET_TYPE_CATEGORY_MEASURE,
	[BucketType.ENUM_MEASURE]: Lang.INDICATOR.BUCKET.BUCKET_TYPE_ENUM_MEASURE
};
