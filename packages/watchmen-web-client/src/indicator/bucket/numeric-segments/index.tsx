...
export const NumericSegments = (props: { holder: NumericSegmentsHolder }) => {
	...
	const header = <>
		<SegmentTableHeaderLabel>{Lang.INDICATOR.BUCKET.VALUE_SEGMENT_MIN_LABEL}</SegmentTableHeaderLabel>
		<SegmentTableHeaderLabel>{Lang.INDICATOR.BUCKET.VALUE_SEGMENT_MAX_LABEL}</SegmentTableHeaderLabel>
	</>;
