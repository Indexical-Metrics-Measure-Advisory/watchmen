...
const InternalAchievementQuery = () => {
	...
	return <TupleWorkbench title={Lang.INDICATOR.ACHIEVEMENT.TITLE}
	                       createButtonLabel={Lang.INDICATOR.ACHIEVEMENT.CREATE_ACHIEVEMENT} canCreate={true}
	                       searchPlaceholder={Lang.PLAIN.FIND_ACHIEVEMENT_PLACEHOLDER}
	                       tupleLabel={Lang.INDICATOR.ACHIEVEMENT.LABEL}
	                       newTupleLabelPrefix={Lang.INDICATOR.ACHIEVEMENT.NEW_ACHIEVEMENT_PREFIX}
	                       existingTupleLabelPrefix={Lang.INDICATOR.ACHIEVEMENT.EXISTING_ACHIEVEMENT_PREFIX}
