...
export const Relevant = () => {
	...
	}, [fireGlobal, data, active, done, constructed, detected]);
	...
	const relevantTypeOptions = [
		{value: '', label: Lang.INDICATOR.INDICATOR.IRRELEVANT},
		...[
	...
	return <Step index={IndicatorDeclarationStep.RELEVANT_INDICATORS} visible={visible} ref={ref}>
		<StepTitle visible={visible}>
			<EmphaticSinkingLabel>
				{Lang.INDICATOR.INDICATOR.RELEVANT_TITLE}
			</EmphaticSinkingLabel>
		</StepTitle>
			...
			{hasRelevantIndicator
				? <RelevantIndicatorsContainer>
					<RelevantIndicatorsHeader>
						<RelevantIndicatorsHeaderCell/>
						<RelevantIndicatorsHeaderCell>
							{Lang.INDICATOR.INDICATOR.INDICATOR_NAME}
						</RelevantIndicatorsHeaderCell>
						<RelevantIndicatorsHeaderCell>
							{Lang.INDICATOR.INDICATOR.INDICATOR_RELEVANT_TYPE}
						</RelevantIndicatorsHeaderCell>
					</RelevantIndicatorsHeader>
				...
				: (detected
					? <NoRelevant>
						{Lang.INDICATOR.INDICATOR.NO_RELEVANT_DETECTED}
					</NoRelevant>
					: null)}
			<StepBodyButtons>
				<StepTitleButton ink={ButtonInk.PRIMARY} onClick={onDetectClicked}>
					{Lang.INDICATOR.INDICATOR.DETECT_RELEVANT}
				</StepTitleButton>
				{done
					? null
					: <>
						...
						<StepTitleButton ink={ButtonInk.DANGER} onClick={onIgnoreDetectClicked}>
							{Lang.INDICATOR.INDICATOR.IGNORE_DETECT_RELEVANT}
						</StepTitleButton>
					</>}
			</StepBodyButtons>
		</StepBody>
