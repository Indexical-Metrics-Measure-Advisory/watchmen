...
/** topic tags: editing, search and display; switched off by default, set REACT_APP_TOPIC_TAGS_ENABLED=true to turn on */
export const isTopicTagsEnabled = () => process.env.REACT_APP_TOPIC_TAGS_ENABLED === 'true';
