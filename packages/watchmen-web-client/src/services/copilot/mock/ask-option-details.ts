			...
			switch (token) {
				...
				case 'previous-month':
					return {
						...
						data: [
							{
								type: CopilotAnswerItemType.MARKDOWN, content: `The following are some examples of the diagrams, charts and graphs that can be made using Mermaid and the Markdown-inspired text specific to it. 
