...
export const Apis = {
	...
	TOPIC_AVAILABLE_TAGS: 'topic/tag/available',
	TAG_LIST_BY_NAME: 'tag/name?query_name=:search',
	TAG_GET: 'tag?tag_id=:tagId',
	TAG_CREATE: 'tag',
	TAG_SAVE: 'tag',
	TAG_LIST_BY_TYPE: 'tag/list/type?type=:type',
	TOPIC_PROFILE: 'dqc/topic/profile?topic_id=:topicId&start_date=:startDate&end_date=:endDate',
	...
	TOPIC_FACTOR_CONSANGUINITY: 'lineage/topic/factor/consanguinity?topic_id=:topicId&factor_id=:factorId',
