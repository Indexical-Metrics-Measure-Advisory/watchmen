...
from watchmen_storage_postgresql import TopicDataStoragePostgreSQL
from watchmen_storage_rds import build_sort_for_statement, SQLAlchemyStatement, StorageRDS
...
class StorageAuroraLimitless(StorageRDS):
	def build_criteria_for_statement(
		...
		from watchmen_storage_postgresql.where_build import build_criteria_for_statement
...
class TopicDataStorageAuroraLimitless(StorageAuroraLimitless, TopicDataStoragePostgreSQL):
