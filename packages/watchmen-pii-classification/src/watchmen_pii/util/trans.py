"""Transaction helpers — copied verbatim (logic-wise) from
``watchmen-rest-dqc/util/trans.py`` and ``watchmen-metricflow/util/trans.py``,
following the project convention that each rest-style package ships its own
copy.
"""
