...
from .table_defs_postgresql import find_table, register_table
...
class StoragePostgreSQL(TransactionalStorageSPI):
	"""
...
# noinspection DuplicatedCode
class TopicDataStoragePostgreSQL(StoragePostgreSQL, TopicDataStorageSPI):
