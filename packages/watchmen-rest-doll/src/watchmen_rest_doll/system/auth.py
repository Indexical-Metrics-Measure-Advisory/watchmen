...
from watchmen_meta_service.admin.user import USER_ENTITY_NAME, USER_ENTITY_SHAPER, UserService
...
def authenticate(username, password) -> User:
	...
	user_service = UserService(doll.meta_storage, doll.snowflake_generator, PrincipalService(User()))
