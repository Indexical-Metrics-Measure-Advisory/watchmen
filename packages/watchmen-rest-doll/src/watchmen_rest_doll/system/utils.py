...
from watchmen_model.system import DataSource, ExternalWriter, KafkaCollectorConfig, Plugin
...
def attach_name(
		data: Union[Plugin, DataSource, ExternalWriter, KafkaCollectorConfig],
...
def attach_tenant_name(
		data_list: Union[List[Plugin], List[DataSource], List[ExternalWriter], List[KafkaCollectorConfig]],
		principal_service: PrincipalService):
