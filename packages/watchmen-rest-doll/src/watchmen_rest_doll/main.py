...
from .admin import enumeration_router, pipeline_graphic_router, pipeline_router, topic_router, user_group_router, \
	user_router
from .auth import authenticate_router
from .console import connected_space_graphic_router, connected_space_router, dashboard_router, subject_router
