...
from watchmen_meta.common import ask_snowflake_generator, ask_meta_storage, ask_snowflake_competitive_workers_v2, get_snowflake_worker
...
def main(event, context):
    ...
    try:
        ...
        release_worker_id(snowflake_generator.workerId)
