...
ALTER TABLE catalogs CHANGE tenantid tenant_id VARCHAR(50) NOT NULL;
ALTER TABLE catalogs DROP createtime;
ALTER TABLE catalogs DROP lastmodified;
ALTER TABLE catalogs ADD created_at DATETIME DEFAULT NOW() NOT NULL;
ALTER TABLE catalogs ADD created_by VARCHAR(50) DEFAULT '-1' NOT NULL;
ALTER TABLE catalogs ADD last_modified_at DATETIME DEFAULT NOW() NOT NULL;
ALTER TABLE catalogs ADD last_modified_by VARCHAR(50) DEFAULT '-1' NOT NULL;
ALTER TABLE catalogs ADD version BIGINT NULL;
