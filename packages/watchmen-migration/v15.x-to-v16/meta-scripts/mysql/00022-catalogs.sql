...
ALTER TABLE catalogs ADD created_at DATETIME NOT NULL;
ALTER TABLE catalogs ADD created_by VARCHAR(50) NOT NULL;
ALTER TABLE catalogs ADD last_modified_at DATETIME NOT NULL;
ALTER TABLE catalogs ADD last_modified_by VARCHAR(50) NOT NULL;
