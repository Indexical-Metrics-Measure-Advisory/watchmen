...
ALTER TABLE user_groups ADD created_at DATETIME NOT NULL;
ALTER TABLE user_groups ADD created_by VARCHAR(50) NOT NULL;
ALTER TABLE user_groups ADD last_modified_at DATETIME NOT NULL;
ALTER TABLE user_groups ADD last_modified_by VARCHAR(50) NOT NULL;
