...
ALTER TABLE user_groups DROP createtime;
ALTER TABLE user_groups DROP lastmodified;
ALTER TABLE user_groups ADD created_at DATETIME DEFAULT NOW() NOT NULL;
ALTER TABLE user_groups ADD created_by VARCHAR(50) DEFAULT '-1' NOT NULL;
ALTER TABLE user_groups ADD last_modified_at DATETIME DEFAULT NOW() NOT NULL;
ALTER TABLE user_groups ADD last_modified_by VARCHAR(50) DEFAULT '-1' NOT NULL;
ALTER TABLE user_groups ADD version BIGINT NULL;
