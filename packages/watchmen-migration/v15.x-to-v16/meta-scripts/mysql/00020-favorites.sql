...
ALTER TABLE favorites CHANGE userid user_id VARCHAR(50) NOT NULL;
ALTER TABLE favorites CHANGE tenantid tenant_id VARCHAR(50) NOT NULL;
ALTER TABLE favorites DROP createtime;
ALTER TABLE favorites DROP lastmodified;
ALTER TABLE favorites ADD last_visit_time DATETIME DEFAULT NOW() NOT NULL;
