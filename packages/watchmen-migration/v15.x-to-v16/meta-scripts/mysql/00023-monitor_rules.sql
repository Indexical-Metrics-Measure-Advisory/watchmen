...
ALTER TABLE monitor_rules ADD created_at DATETIME NOT NULL;
ALTER TABLE monitor_rules ADD created_by VARCHAR(50) NOT NULL;
ALTER TABLE monitor_rules ADD last_modified_at DATETIME NOT NULL;
ALTER TABLE monitor_rules ADD last_modified_by VARCHAR(50) NOT NULL;
