...
ALTER TABLE pipeline_index CHANGE pipelineid pipeline_id VARCHAR(50) NOT NULL;
ALTER TABLE pipeline_index CHANGE pipelinename pipeline_name VARCHAR(50) NULL;
ALTER TABLE pipeline_index CHANGE stageid stage_id VARCHAR(50) NULL;
ALTER TABLE pipeline_index CHANGE stagename stage_name VARCHAR(100) NULL;
...
ALTER TABLE pipeline_index ADD tenant_id VARCHAR(50) NOT NULL;
ALTER TABLE pipeline_index DROP factorid;
ALTER TABLE pipeline_index DROP reftype;
ALTER TABLE pipeline_index DROP createtime;
ALTER TABLE pipeline_index DROP lastmodified;
ALTER TABLE pipeline_index ADD created_at DATETIME DEFAULT NOW() NOT NULL;
ALTER TABLE pipeline_index ADD last_modified_at DATETIME DEFAULT NOW() NOT NULL;
