...
ALTER TABLE dashboards DROP createtime;
ALTER TABLE dashboards DROP lastmodified;
ALTER TABLE dashboards ADD created_at DATETIME DEFAULT NOW() NOT NULL;
ALTER TABLE dashboards ADD created_by VARCHAR(50) DEFAULT '-1' NOT NULL;
ALTER TABLE dashboards ADD last_modified_at DATETIME DEFAULT NOW() NOT NULL;
ALTER TABLE dashboards ADD last_modified_by VARCHAR(50) DEFAULT '-1' NOT NULL;
