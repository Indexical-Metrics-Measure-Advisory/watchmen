...
ALTER TABLE tenants MODIFY name VARCHAR(50) NULL;
ALTER TABLE tenants DROP createtime;
ALTER TABLE tenants DROP lastmodified;
ALTER TABLE tenants ADD created_at DATETIME DEFAULT NOW() NOT NULL;
ALTER TABLE tenants ADD created_by VARCHAR(50) DEFAULT '-1' NOT NULL;
ALTER TABLE tenants ADD last_modified_at DATETIME DEFAULT NOW() NOT NULL;
ALTER TABLE tenants ADD last_modified_by VARCHAR(50) DEFAULT '-1' NOT NULL;
ALTER TABLE tenants ADD version BIGINT NULL;
