...
ALTER TABLE factor_index CHANGE factorid factor_id VARCHAR(50) NOT NULL;
ALTER TABLE factor_index CHANGE type factor_type VARCHAR(50) NOT NULL;
ALTER TABLE factor_index CHANGE name factor_name VARCHAR(255) NOT NULL;
ALTER TABLE factor_index CHANGE label factor_label VARCHAR(255) NULL;
...
ALTER TABLE factor_index DROP createtime;
ALTER TABLE factor_index DROP lastmodified;
ALTER TABLE factor_index ADD created_at DATETIME DEFAULT NOW() NOT NULL;
ALTER TABLE factor_index ADD last_modified_at DATETIME DEFAULT NOW() NOT NULL;
