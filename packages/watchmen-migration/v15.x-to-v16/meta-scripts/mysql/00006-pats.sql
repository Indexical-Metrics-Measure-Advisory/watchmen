...
ALTER TABLE pats CHANGE tokenid token VARCHAR(255) NOT NULL;
ALTER TABLE pats CHANGE userid user_id VARCHAR(50) NOT NULL;
ALTER TABLE pats MODIFY username VARCHAR(50) NULL;
ALTER TABLE pats CHANGE tenantid tenant_id VARCHAR(50) NOT NULL;
