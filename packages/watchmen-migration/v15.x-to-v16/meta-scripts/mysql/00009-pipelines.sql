...
ALTER TABLE pipelines CHANGE pipelineid pipeline_id VARCHAR(50) NOT NULL;
...
ALTER TABLE pipelines DROP createtime;
ALTER TABLE pipelines DROP lastmodified;
ALTER TABLE pipelines ADD created_at DATETIME DEFAULT NOW() NOT NULL;
ALTER TABLE pipelines ADD created_by VARCHAR(50) DEFAULT '-1' NOT NULL;
ALTER TABLE pipelines ADD last_modified_at DATETIME DEFAULT NOW() NOT NULL;
ALTER TABLE pipelines ADD last_modified_by VARCHAR(50) DEFAULT '-1' NOT NULL;
ALTER TABLE pipelines ADD version BIGINT NULL;
