...
ALTER TABLE pipelines ADD created_at DATETIME NOT NULL;
ALTER TABLE pipelines ADD created_by VARCHAR(50) NOT NULL;
ALTER TABLE pipelines ADD last_modified_at DATETIME NOT NULL;
ALTER TABLE pipelines ADD last_modified_by VARCHAR(50) NOT NULL;
