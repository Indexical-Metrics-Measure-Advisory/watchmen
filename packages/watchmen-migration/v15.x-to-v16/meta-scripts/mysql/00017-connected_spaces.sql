...
ALTER TABLE connected_spaces ADD created_by VARCHAR(50) DEFAULT '-1' NOT NULL;
ALTER TABLE connected_spaces ADD last_modified_at DATETIME DEFAULT NOW() NOT NULL;
ALTER TABLE connected_spaces ADD last_modified_by VARCHAR(50) DEFAULT '-1' NOT NULL;
