...
ALTER TABLE spaces DROP createtime;
ALTER TABLE spaces DROP lastmodified;
ALTER TABLE spaces ADD created_at DATETIME DEFAULT NOW() NOT NULL;
ALTER TABLE spaces ADD created_by VARCHAR(50) DEFAULT '-1' NOT NULL;
ALTER TABLE spaces ADD last_modified_at DATETIME DEFAULT NOW() NOT NULL;
ALTER TABLE spaces ADD last_modified_by VARCHAR(50) DEFAULT '-1' NOT NULL;
ALTER TABLE spaces ADD version BIGINT NULL;
