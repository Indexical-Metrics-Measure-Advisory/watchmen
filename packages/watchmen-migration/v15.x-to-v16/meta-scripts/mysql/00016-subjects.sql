...
ALTER TABLE subjects ADD created_at DATETIME DEFAULT NOW() NOT NULL;
ALTER TABLE subjects ADD created_by VARCHAR(50) DEFAULT '-1' NOT NULL;
ALTER TABLE subjects ADD last_modified_at DATETIME DEFAULT NOW() NOT NULL;
ALTER TABLE subjects ADD last_modified_by VARCHAR(50) DEFAULT '-1' NOT NULL;
