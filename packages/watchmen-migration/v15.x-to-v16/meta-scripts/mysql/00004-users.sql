...
ALTER TABLE users DROP lastmodified;
ALTER TABLE users ADD created_at DATETIME DEFAULT NOW() NOT NULL;
ALTER TABLE users ADD created_by VARCHAR(50) DEFAULT '-1' NOT NULL;
ALTER TABLE users ADD last_modified_at DATETIME DEFAULT NOW() NOT NULL;
ALTER TABLE users ADD last_modified_by VARCHAR(50) DEFAULT '-1' NOT NULL;
ALTER TABLE users ADD version BIGINT NULL;
