...
ALTER TABLE users ADD created_by VARCHAR(50) NOT NULL;
ALTER TABLE users ADD last_modified_at DATETIME NOT NULL;
ALTER TABLE users ADD last_modified_by VARCHAR(50) NOT NULL;
