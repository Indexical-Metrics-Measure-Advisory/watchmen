...
ALTER TABLE topics ADD created_by VARCHAR(50) NOT NULL;
ALTER TABLE topics ADD last_modified_at DATETIME NOT NULL;
ALTER TABLE topics ADD last_modified_by VARCHAR(50) NOT NULL;
