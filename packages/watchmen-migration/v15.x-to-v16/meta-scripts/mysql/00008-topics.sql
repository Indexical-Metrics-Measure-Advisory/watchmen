...
ALTER TABLE topics CHANGE tenantid tenant_id VARCHAR(50) NOT NULL;
ALTER TABLE topics DROP createtime;
ALTER TABLE topics DROP lastmodified;
ALTER TABLE topics ADD created_at DATETIME DEFAULT NOW() NOT NULL;
ALTER TABLE topics ADD created_by VARCHAR(50) DEFAULT '-1' NOT NULL;
ALTER TABLE topics ADD last_modified_at DATETIME DEFAULT NOW() NOT NULL;
ALTER TABLE topics ADD last_modified_by VARCHAR(50) DEFAULT '-1' NOT NULL;
ALTER TABLE topics ADD version BIGINT NULL;
