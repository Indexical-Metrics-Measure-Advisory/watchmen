...
ALTER TABLE pipeline_graphics MODIFY (user_id VARCHAR2(50));
ALTER TABLE pipeline_graphics RENAME COLUMN tenantid TO tenant_id;
ALTER TABLE pipeline_graphics MODIFY (tenant_id VARCHAR2(50));
...
UPDATE pipeline_graphics SET created_at = SYSDATE, last_modified_at = SYSDATE;
