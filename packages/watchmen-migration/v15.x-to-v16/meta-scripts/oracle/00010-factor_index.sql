...
ALTER TABLE factor_index MODIFY factor_index_id VARCHAR2(50);
ALTER TABLE factor_index RENAME COLUMN factorid TO factor_id;
ALTER TABLE factor_index MODIFY factor_id VARCHAR2(50);
ALTER TABLE factor_index RENAME COLUMN type TO factor_type;
ALTER TABLE factor_index MODIFY factor_type VARCHAR2(50);
ALTER TABLE factor_index RENAME COLUMN name TO factor_name;
ALTER TABLE factor_index MODIFY factor_name VARCHAR2(255);
ALTER TABLE factor_index RENAME COLUMN label TO factor_label;
ALTER TABLE factor_index MODIFY factor_label VARCHAR2(255);
...
ALTER TABLE factor_index MODIFY topic_name VARCHAR2(50);
ALTER TABLE factor_index RENAME COLUMN tenantid TO tenant_id;
ALTER TABLE factor_index MODIFY tenant_id VARCHAR2(50);
