...
ALTER TABLE topics MODIFY topic_id VARCHAR2(50);
ALTER TABLE topics MODIFY description VARCHAR2(1024);
...
ALTER TABLE topics MODIFY data_source_id VARCHAR2(50);
ALTER TABLE topics RENAME COLUMN tenantid TO tenant_id;
ALTER TABLE topics MODIFY tenant_id VARCHAR2(50);
