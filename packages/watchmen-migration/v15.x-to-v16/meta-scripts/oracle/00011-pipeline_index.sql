...
ALTER TABLE pipeline_index MODIFY pipeline_index_id VARCHAR2(50);
ALTER TABLE pipeline_index RENAME COLUMN pipelineid TO pipeline_id;
ALTER TABLE pipeline_index MODIFY pipeline_id VARCHAR2(50);
ALTER TABLE pipeline_index RENAME COLUMN pipelinename TO pipeline_name;
ALTER TABLE pipeline_index MODIFY pipeline_name VARCHAR2(50);
...
ALTER TABLE pipeline_index MODIFY stage_name VARCHAR2(100);
ALTER TABLE pipeline_index RENAME COLUMN unitid TO unit_id;
ALTER TABLE pipeline_index MODIFY unit_id VARCHAR2(50);
ALTER TABLE pipeline_index RENAME COLUMN unitname TO unit_name;
ALTER TABLE pipeline_index MODIFY unit_name VARCHAR2(100);
ALTER TABLE pipeline_index RENAME COLUMN actionid TO action_id;
ALTER TABLE pipeline_index MODIFY action_id VARCHAR2(50);
...
ALTER TABLE pipeline_index MODIFY mapping_to_factor_id VARCHAR2(50);
