...
ALTER TABLE last_snapshots MODIFY (last_dashboard_id VARCHAR2(50));
ALTER TABLE last_snapshots RENAME COLUMN admindashboardid TO admin_dashboard_id;
ALTER TABLE last_snapshots MODIFY (admin_dashboard_id VARCHAR2(50));
ALTER TABLE last_snapshots RENAME COLUMN favoritepin TO favorite_pin;
ALTER TABLE last_snapshots MODIFY (favorite_pin NUMBER(1));
ALTER TABLE last_snapshots RENAME COLUMN userid TO user_id;
ALTER TABLE last_snapshots MODIFY (user_id VARCHAR2(50));
ALTER TABLE last_snapshots RENAME COLUMN tenantid TO tenant_id;
ALTER TABLE last_snapshots MODIFY (tenant_id VARCHAR2(50));
ALTER TABLE last_snapshots DROP COLUMN createtime;
