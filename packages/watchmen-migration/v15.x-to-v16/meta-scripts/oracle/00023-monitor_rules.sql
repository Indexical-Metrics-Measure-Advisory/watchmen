...
ALTER TABLE monitor_rules MODIFY (rule_id VARCHAR2(50));
...
ALTER TABLE monitor_rules MODIFY (topic_id VARCHAR2(50));
ALTER TABLE monitor_rules RENAME COLUMN factorid TO factor_id;
ALTER TABLE monitor_rules MODIFY (factor_id VARCHAR2(50));
