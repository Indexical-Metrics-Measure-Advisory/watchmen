...
ALTER TABLE reports MODIFY report_id VARCHAR2(50);
...
ALTER TABLE reports DROP COLUMN simulating_1;
...
ALTER TABLE reports ADD user_id VARCHAR2(50) NULL;
ALTER TABLE reports RENAME COLUMN tenantid TO tenant_id;
ALTER TABLE reports MODIFY tenant_id VARCHAR2(50);
ALTER TABLE reports RENAME COLUMN lastvisittime TO last_visit_time;
ALTER TABLE reports MODIFY last_visit_time DATE DEFAULT SYSDATE NOT NULL;
