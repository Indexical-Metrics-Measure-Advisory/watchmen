...
ALTER TABLE key_stores MODIFY (tenant_id VARCHAR2(50));
...
ALTER TABLE key_stores DROP COLUMN lastmodified;
ALTER TABLE key_stores ADD (created_at DATE DEFAULT SYSDATE NOT NULL);
ALTER TABLE key_stores ADD (created_by VARCHAR2(50) DEFAULT '-1' NOT NULL);
ALTER TABLE key_stores ADD CONSTRAINT pk_key_stores PRIMARY KEY (tenant_id, key_type);
