...
ALTER TABLE dashboards ADD created_at DATE DEFAULT SYSDATE NOT NULL;
ALTER TABLE dashboards ADD created_by VARCHAR2(50) DEFAULT '-1' NOT NULL;
ALTER TABLE dashboards ADD last_modified_at DATE DEFAULT SYSDATE NOT NULL;
ALTER TABLE dashboards ADD last_modified_by VARCHAR2(50) DEFAULT '-1' NOT NULL;
