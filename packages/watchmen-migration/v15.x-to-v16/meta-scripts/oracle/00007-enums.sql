...
ALTER TABLE enums MODIFY tenant_id VARCHAR2(50);
...
CREATE OR REPLACE PROCEDURE WATCHMEN_MIGRATION_COPY_ENUM_ITEMS IS
    CURSOR cur_list IS SELECT enum_id, tenant_id, items FROM enums WHERE items IS NOT NULL;
