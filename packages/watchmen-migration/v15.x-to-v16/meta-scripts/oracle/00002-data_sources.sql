...
ALTER TABLE data_sources MODIFY data_source_id VARCHAR2(50);
ALTER TABLE data_sources RENAME COLUMN dataSourceCode TO data_source_code;
ALTER TABLE data_sources MODIFY data_source_code VARCHAR2(50);
ALTER TABLE data_sources RENAME COLUMN dataSourceType TO data_source_type;
ALTER TABLE data_sources MODIFY data_source_type VARCHAR2(50);
ALTER TABLE data_sources MODIFY port VARCHAR2(5);
ALTER TABLE data_sources MODIFY url VARCHAR2(255);
ALTER TABLE data_sources RENAME COLUMN tenantid TO tenant_id;
ALTER TABLE data_sources MODIFY tenant_id VARCHAR2(50);
