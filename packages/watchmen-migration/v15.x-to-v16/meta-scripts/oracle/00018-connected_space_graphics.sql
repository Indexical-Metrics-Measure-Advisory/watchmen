...
ALTER TABLE connected_space_graphics MODIFY (user_id VARCHAR2(50) NOT NULL);
ALTER TABLE connected_space_graphics RENAME COLUMN tenantid TO tenant_id;
ALTER TABLE connected_space_graphics MODIFY (tenant_id VARCHAR2(50));
ALTER TABLE connected_space_graphics DROP COLUMN createtime;
ALTER TABLE connected_space_graphics DROP COLUMN lastmodified;
