...
ALTER TABLE pipelines MODIFY (pipeline_id VARCHAR2(50));
ALTER TABLE pipelines RENAME COLUMN topicid TO topic_id;
ALTER TABLE pipelines MODIFY (topic_id VARCHAR2(50));
