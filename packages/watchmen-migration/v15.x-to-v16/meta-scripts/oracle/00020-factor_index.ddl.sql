...
ALTER TABLE factor_index MODIFY (factor_index_id VARCHAR2(50) NOT NULL);
ALTER TABLE factor_index RENAME COLUMN factorid TO factor_id;
ALTER TABLE factor_index MODIFY (factor_id VARCHAR2(50) NOT NULL);
ALTER TABLE factor_index RENAME COLUMN type TO factor_type;
ALTER TABLE factor_index MODIFY (factor_type VARCHAR2(50) NOT NULL);
ALTER TABLE factor_index RENAME COLUMN name TO factor_name;
ALTER TABLE factor_index MODIFY (factor_name VARCHAR2(50) NOT NULL);
ALTER TABLE factor_index RENAME COLUMN label TO factor_label;
ALTER TABLE factor_index MODIFY (factor_label VARCHAR2(100) NULL);
ALTER TABLE factor_index RENAME COLUMN description TO factor_description;
ALTER TABLE factor_index MODIFY (factor_description VARCHAR2(100) NULL);
ALTER TABLE factor_index RENAME COLUMN topicid TO topic_id;
ALTER TABLE factor_index MODIFY (topic_id VARCHAR2(50) NOT NULL);
ALTER TABLE factor_index RENAME COLUMN topicname TO topic_name;
ALTER TABLE factor_index MODIFY (topic_name VARCHAR2(50) NOT NULL);
ALTER TABLE factor_index RENAME COLUMN tenantid TO tenant_id;
ALTER TABLE factor_index MODIFY (tenant_id VARCHAR2(50) NOT NULL);
ALTER TABLE factor_index DROP COLUMN createtime;
ALTER TABLE factor_index DROP COLUMN lastmodified;
ALTER TABLE factor_index ADD (created_at DATE DEFAULT SYSDATE NOT NULL);
ALTER TABLE factor_index ADD (last_modified_at DATE DEFAULT SYSDATE NOT NULL);
