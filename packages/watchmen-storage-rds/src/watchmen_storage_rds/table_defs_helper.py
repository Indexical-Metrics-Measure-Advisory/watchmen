...
from sqlalchemy import Boolean, Column, Date, DateTime, Integer, JSON, MetaData, String, Text, Numeric
...
def create_number(name: str, nullable: bool = True) -> Column:
	return Column(name, Numeric, nullable=nullable)
