...
(
    catalog_id       VARCHAR2(60)  NOT NULL,
...
(
    ...
    product_version  VARCHAR2(32),
    catalog_id       VARCHAR2(60),
...
(
    ...
    snapshot_date    VARCHAR2(20) NOT NULL,
    total_topics     NUMBER(10),
    total_rows       NUMBER(20),
    total_factors    NUMBER(10),
