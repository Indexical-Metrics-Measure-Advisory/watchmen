...
(
    pipeline_index_id     VARCHAR2(50) NOT NULL,
    pipeline_id           VARCHAR2(50) NOT NULL,
    pipeline_name         VARCHAR2(45),
    ...
    mapping_to_topic_id   VARCHAR2(50) NOT NULL,
    mapping_to_factor_id  VARCHAR2(50) NOT NULL,
    source_from_topic_id  VARCHAR2(50) NOT NULL,
    source_from_factor_id VARCHAR2(50) NOT NULL,
