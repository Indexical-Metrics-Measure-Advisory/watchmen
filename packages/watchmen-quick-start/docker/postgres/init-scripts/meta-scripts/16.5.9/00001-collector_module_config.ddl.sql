...
CREATE INDEX i_collector_module_config_4 ON collector_module_config (last_modified_at);
CREATE INDEX i_collector_module_config_5 ON collector_module_config (last_modified_by);